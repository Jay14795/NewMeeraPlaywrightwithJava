...
/**
 * Duplicate-campaign flow. Port of {@code tests/duplicateCampaignTests.spec.js}.
 */
public class DuplicateCampaignTests extends AuthenticatedTest {
    ...
    public void duplicateCampaign(Map<String, String> data) {
        ...
        List<Map<String, String>> numbersData =
                ExcelDataReader.getTestData(Config.CAMPAIGN_DATA, "Numbers");
        ...
        // no Duplicate icon, so we exclude them and require the duplicate link to exist.
